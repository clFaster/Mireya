...
namespace Mireya.ApiClient.Migrations
{
    ...
    public partial class NewModels : Migration
    {
        ...
        {
            migrationBuilder.DropForeignKey(name: "FK_Display_Zone_ZoneId", table: "Display");

            migrationBuilder.DropTable(name: "ZoneCampaign");

            migrationBuilder.DropTable(name: "Zone");

            migrationBuilder.DropIndex(name: "IX_Display_ZoneId", table: "Display");

            migrationBuilder.DropColumn(name: "OfflineAlertedAt", table: "Display");

            migrationBuilder.DropColumn(name: "ZoneId", table: "Display");
        }
    }
}
